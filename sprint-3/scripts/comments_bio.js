...
form.addEventListener("submit", newPost => {
    ...
    let newAdd = axios.post("https://project-1-api.herokuapp.com/comments?api_key=9c3db58b-4bbe-45f7-b0cf-882039feca9651111", {
    ...
    newAdd.then(() => {
        ...
        let arrComment = axios.get("https://project-1-api.herokuapp.com/comments?api_key=9c3db58b-4bbe-45f7-b0cf-882039feca9651111")
        .then(response => {
...
const arrComment = axios.get("https://project-1-api.herokuapp.com/comments?api_key=9c3db58b-4bbe-45f7-b0cf-882039feca9651111")
