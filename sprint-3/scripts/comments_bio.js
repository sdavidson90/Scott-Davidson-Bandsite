...
const apiKey = "9c3db58b-4bbe-45f7-b0cf-882039feca96511";
...
form.addEventListener("submit", newPost => {
    ...
    let newAdd = axios.post("https://project-1-api.herokuapp.com/comments?api_key=9c3db58b-4bbe-45f7-b0cf-882039feca96511", {
    ...
    newAdd.then(() => {
        ...
        let arrComment = axios.get("https://project-1-api.herokuapp.com/comments?api_key=9c3db58b-4bbe-45f7-b0cf-882039feca96511")
        .then(response => {
...
//GETTING THE DATA FROM HEROKU TO POST ON PAGE LOAD-UP AND SORTING IT FROM NEWEST TIMESTAMP TO OLDEST
const arrComment = axios.get("https://project-1-api.herokuapp.com/comments?api_key=9c3db58b-4bbe-45f7-b0cf-882039feca96511")
