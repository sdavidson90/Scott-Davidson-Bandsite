...
const apiKey = "9c3db58b-4bbe-45f7-b0cf-882039feca965111";
...
form.addEventListener("submit", newPost => {
    ...
    let newAdd = axios.post("https://project-1-api.herokuapp.com/comments?api_key=9c3db58b-4bbe-45f7-b0cf-882039feca965111", {
    ...
    newAdd.then(() => {
        ...
        let arrComment = axios.get("https://project-1-api.herokuapp.com/comments?api_key=9c3db58b-4bbe-45f7-b0cf-882039feca965111")
        .then(response => {
...
const arrComment = axios.get("https://project-1-api.herokuapp.com/comments?api_key=9c3db58b-4bbe-45f7-b0cf-882039feca965111")
...
function removePost(id){
    axios.delete(`https://project-1-api.herokuapp.com/comments/${id}?api_key=9c3db58b-4bbe-45f7-b0cf-882039feca965111`)
    .then(response => {
        axios.get("https://project-1-api.herokuapp.com/comments?api_key=9c3db58b-4bbe-45f7-b0cf-882039feca965111")
        arrComment.then(response => {
            //CALLING DOM FUNCTION TO POST THE DATA AND SORT IT BY NEWEST TIMESTAMP AT TOP
            displayComments(
                response.data.sort(function(a, b) {
